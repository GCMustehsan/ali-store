...
// // Add the createManualSale function to the controller

// // Create manual sale
// exports.createManualSale = async (req, res) => {
//   try {
//     const { total, profit, paymentMethod, description, date, isManual } = req.body

//     // Validate required fields
//     if (total === undefined || profit === undefined || !paymentMethod) {
//       return res.status(400).json({
//         success: false,
//         message: "Total amount, profit, and payment method are required",
//       })
//     }

//     // Create empty sale record with manual flag
//     const sale = await Sale.create({
//       items: [],
//       total,
//       profit,
...
exports.getManualSales = async (req, res) => {
  try {
    const manualSales = await Sale.find({ isManual: true }).sort({ date: -1 })
